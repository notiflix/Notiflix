...
var Notiflix = {
    ...
    Notify: {
        ...
        Success: function (message, callback) {
            ...
            !newNotifySettings ? Notiflix.Notify.Init({}) : newNotifySettings;
    ...
    Report: {
        ...
        Success: function (title, message, buttonText, buttonCallback) {
            ...
            // if not initialized pretend like init   
            !newReportSettings ? Notiflix.Report.Init({}) : newReportSettings;
    ...
    Confirm: {
        ...
        Show: function (title, message, okText, cancelText, okCallback, cancelCallback) {
            ...
            // if not initialized pretend like init
            !newConfirmSettings ? Notiflix.Confirm.Init({}) : newConfirmSettings;
    ...
    Loading: {
        ...
        Standard: function (message) {
            ...
            // if not initialized pretend like init
            !newLoadingSettings ? Notiflix.Loading.Init({}) : newLoadingSettings;
